 ...
 * Date: May 13, 2017
 * Class: CBC.java
 * Description: This class performs encryption using cipher block chaining mode.
 */
...
public class CBC {
	...
	private State[] blocks; //Array of states
	 ...
	 * @throws Exception
	 */
    public CBC(boolean encrypt, byte[] plaintext, byte[] keyA, byte[] IV) throws Exception{
    	encrypting = encrypt;
