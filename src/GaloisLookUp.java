 ...
 * Date: May 13, 2017
 * Class: GaloisLookUp.java
 * Description: This class holds the lookup tables
 * 				for Galois field multiplication.
 */

public class GaloisLookUp {
	...
	public static byte multiply(byte b, int n) throws Exception{
		if(n != 1 && n != 2 && n != 3 && n != 9 && n != 11 && n != 13 && n != 14) throw new Exception ("Can only multipy by 1,2,3,9,11,13,14");
		//Get the Row of the S box (first 4 bits)
		byte rowIdex = (byte) ((b >> 4) & 0xF);
		//Get the column of the SBox (last 4 bits)
		byte colIndex = (byte) (b  & 0xF);
		
		switch(n){
			case 1: return b;
			case 2: return mul2[rowIdex][colIndex];
			case 3: return mul3[rowIdex][colIndex];
			case 9: return mul9[rowIdex][colIndex];
			case 11: return mul11[rowIdex][colIndex];
			case 13: return mul13[rowIdex][colIndex];
			case 14: return mul14[rowIdex][colIndex];
		}
		return 0;
		
	}
//	/**
//	 * Returns the value of the given byte multiplied by 2.
//	 * @param b
//	 * @return
//	 */
...
//		//Get the column of the SBox (last 4 bits)
//		byte colIndex = (byte) (b  & 0xF);
//		//Return the value in the lookup table
//		return mul2[rowIdex][colIndex];
//	}
//	
//	/**
//	 * Returns the value of the given byte multiplied by 3.
//	 * @param b
//	 * @return
//	 */
